<div>
    ...
    <div class="relative bg-white p-2 rounded-xl w-full shadow-xl">
        <div class="bg-gray-300 rounded-xl flex p-1">
            <p class="text-xl font-semibold my-2 mx-auto">{{ $pedido->id }} / {{ $pedido->local->name }}</p>
            <button wire:click="tomarpedido({{$pedido}})" class="mx-auto rounded-xl text-white bg-green-600 px-2">TOMAR</button>
        </div>
