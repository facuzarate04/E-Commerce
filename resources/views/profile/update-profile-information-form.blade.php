<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Modifica y actualiza tu email y contraseña actual.') }}<br>
        {{ __('En caso de que accidentalmente hayas compartido tu contraseña, te la hayan hackeado 
        o quieras modificar tu dirección de correo, esta opción te ayudará a volver a proteger tus datos.') }}
    </x-slot>
